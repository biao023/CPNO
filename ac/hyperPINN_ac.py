...
def main(args):
    ...
    if args.data_use:
        name = 'hyperpinn-ac-physics'
    else:
        name = 'hyperpinn-ac-hybrid'
    ...
    para_layer =  [100, 64, 64, 64, 64, latent_dim]
    ...
    if args.data_use:
        torch.save(model, rf'{args.log_dir}/hyperpinn_ac_hybrid.pkl')
    else:
        torch.save(model, rf'{args.log_dir}/hyperpinn_ac_physics.pkl')
