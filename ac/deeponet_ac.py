...
def main(args):
    ...
    if args.data_use:
        name = 'deeponet-ac-physics'
    else:
        name = 'deeponet-ac-hybrid'
    ...
    if args.data_use:
        torch.save(model, rf'{args.log_dir}/deeponet_ac_hybrid.pkl')
    else:
        torch.save(model, rf'{args.log_dir}/deeponet_ac_physics.pkl')
