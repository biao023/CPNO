...
def main():
    ...
    if args.data_use:
        name = 'hyperpinn-hybrid-diff'
    else:
        name = 'hyperpinn-physics-diff'
    ...
    if args.data_use:
        torch.save(model, rf'{args.log_dir}/hyperpinn_diff_hybrid.pkl')
    else:
        torch.save(model, rf'{args.log_dir}/hyperpinn_diff_physics.pkl')
