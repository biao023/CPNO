...
def main():
    ...
    if args.data_use:
        name = 'deeponet-hybrid-diff'
    else:
        name = 'deeponet-physics-diff'
    ...
    if args.data_use:
        torch.save(model, rf'{args.log_dir}/deeponet_diff_hybrid.pkl')
    else:
        torch.save(model, rf'{args.log_dir}/deeponet_diff_physics.pkl')
