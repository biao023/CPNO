...
from models.models_poly import PolyINRWithHypernet
...
def define_args():
    ...
    parser.add_argument('--data_use', type=bool, default=True)
...
def main(args):
    ...
    if args.data_use:
        name = 'PolyINR-hybrid={}-epoch={}-lr={}-inr_dim_hidden={}-' \
           'inr_layers={}-hyper_dim_hidden={}-hyper_num_layers={}-c_BC={}-c_PDE={}'.format(
        args.dataset,  args.epochs, args.lr, args.inr_dim_hidden,
        args.inr_num_layers, args.hyper_dim_hidden,args.hyper_num_layers, args.c_bc, args.c_pde)
    else:
        name = 'PolyINR-physics={}-epoch={}-lr={}-inr_dim_hidden={}-' \
               'inr_layers={}-hyper_dim_hidden={}-hyper_num_layers={}-c_BC={}-c_PDE={}'.format(
            args.dataset, args.epochs, args.lr, args.inr_dim_hidden,
            args.inr_num_layers, args.hyper_dim_hidden, args.hyper_num_layers, args.c_bc, args.c_pde)
    ...
    if args.data_use:
        torch.save(model, rf'{args.log_dir}/polyINR_diff_hybrid.pkl')
    else:
        torch.save(model, rf'{args.log_dir}/polyINR_diff_physics.pkl')
