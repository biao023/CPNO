...
def define_args():
    ...
    parser.add_argument('--batch_size_BC', type=int, default=1000, metavar='N')
...
def main(args):
    ...
    if args.data_use:
        torch.save(model, rf'{args.log_dir}/polyINR_cheb_diff_hybrid.pkl')
    else:
        torch.save(model, rf'{args.log_dir}/polyINR_cheb_diff_physics.pkl')
